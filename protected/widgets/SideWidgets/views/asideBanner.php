<?php if ($banner): ?>
    <div class="aside_item banner">
        ...
        <?php else: ?>
            <a target="_blank" data-url="<?php echo $banner->getBannerUrl(); ?>" title="<?php echo $banner->title; ?>" href="<?php echo $banner->getBannerUrl(); ?>"><?php echo CHtml::image($banner->getBannerSourcePath(), $banner->title); ?></a>
        <?php endif; ?>
    </div>
<?php endif; ?>