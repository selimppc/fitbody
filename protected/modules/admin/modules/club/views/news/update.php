...
<div class="control-group">
    <?php echo $form->label($model,'club_id',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo Chosen::activeDropDownList($model, "club_id", $clubs , array('empty' => '', 'options' => array( 'allowSingleDeselect' => true))); ?>
        <?php echo $form->error($model,'club_id',array('class'=>'label label-important')); ?>
    </div>
</div>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        ...
        $this->widget('ImperaviRedactorWidget', array(
            ...
            'options' => array(
                'lang' => 'ru',
                "imageUpload" => "/admin/club/news/upload",
                "minHeight" => 300
            ),
        ));?>
    </div>
...
<div class="control-group formSep">
    ...
    <div class="controls well">
        ...
        $this->widget('ext.xupload.XUpload', array(
                'url' => Yii::app( )->createUrl( "/admin/club/news/uploadNewsImage/item/" . $id),
                'model' => $photos,
                ...
                'options' => array(
                    ...
                    'success'=>"js:function(result, textStatus, jqXHR) {
                                    $('#ClubNews_image_id').attr('value', result[0].image_id);
                                }",
                    'added' => "js:function() {
...
<?php
    ...
    $cs->registerScriptFile('/js/admin/news.js', CClientScript::POS_END);
?>