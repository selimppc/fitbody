...
<?php if(isset($model->id)): ?>
    <h3 class="mb_30">Обновить уровень: <?php echo $model->level; ?></h3>
<?php else: ?>
    <h3 class="mb_30">Добавить новый уровень: </h3>
<?php endif; ?>
...
<div class="control-group formSep">
    <?php echo $form->label($model,'level',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo $form->textField($model,'level'); ?>
        <?php  echo $form->error($model,'level',array('class'=>'label label-important')); ?>
    </div>
</div>
