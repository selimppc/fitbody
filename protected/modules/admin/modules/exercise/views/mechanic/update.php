...
<?php if(isset($model->id)): ?>
    <h3 class="mb_30">Обновить оборудование: <?php echo $model->mechanic; ?></h3>
<?php else: ?>
    <h3 class="mb_30">Добавить новое оборудование: </h3>
<?php endif; ?>
...
<div class="control-group formSep">
    <?php echo $form->label($model,'mechanic',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo $form->textField($model,'mechanic'); ?>
        <?php  echo $form->error($model,'mechanic',array('class'=>'label label-important')); ?>
    </div>
</div>
