<?php if(isset($model->id)): ?>
    <h3 class="mb_30">Обновить часть тела: <?php echo $model->title; ?></h3>
<?php else: ?>
    <h3 class="mb_30">Добавить новую часть тела: </h3>
<?php endif; ?>
...
<div class="control-group formSep">
    <?php echo $form->label($model,'genitive',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo $form->textField($model,'genitive'); ?>
        <?php  echo $form->error($model,'genitive',array('class'=>'label label-important')); ?>
    </div>
</div>
