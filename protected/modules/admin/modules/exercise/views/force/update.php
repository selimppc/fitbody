...
<?php if(isset($model->id)): ?>
    <h3 class="mb_30">Обновить тип силы: <?php echo $model->force; ?></h3>
<?php else: ?>
    <h3 class="mb_30">Добавить новый тип силы: </h3>
<?php endif; ?>
...
<div class="control-group formSep">
    <?php echo $form->label($model,'force',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo $form->textField($model,'force'); ?>
        <?php  echo $form->error($model,'force',array('class'=>'label label-important')); ?>
    </div>
</div>
