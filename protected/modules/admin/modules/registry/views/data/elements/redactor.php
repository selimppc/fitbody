		...
		<?php if($val->language == $key): ?>
			...
			<div <?php if($language!=$key) echo 'style="display:none;"' ?> data-language="<?php echo $key; ?>" class="control-group formSep">
				...
				<div class="controls">
					...
					<?php endif; ?>
					<div style="width: 80%;">
						<textarea data-redactorin="true"  name="elementData[<?php echo $element->id ?>][<?php echo $key; ?>]" id="<?php echo $element->key.$key; ?>" rows="5"><?php echo $val->value; ?></textarea>
					</div>
				</div>
			</div>
		<?php endif; ?>
	...
	<?php if(!$exists): ?>
		<div <?php if($language!=$key) echo 'style="display:none;"' ?> data-language="<?php echo $key; ?>" class="control-group formSep">
			...
			<div class="controls">
				...
				<?php endif; ?>
				<div style="width: 80%;">
					<textarea data-redactorin="true" name="elementData[<?php echo $element->id ?>][<?php echo $key; ?>]" id="<?php echo $element->key.$key; ?>"  rows="5"></textarea>
				</div>
			</div>
		</div>
	<?php endif; ?>
