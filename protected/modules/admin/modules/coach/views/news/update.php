...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo Chosen::activeDropDownList($model, "coach_id", $coaches , array('empty' => '', 'options' => array( 'allowSingleDeselect' => true))); ?>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        ...
        $this->widget('ImperaviRedactorWidget', array(
            ...
            'options' => array(
                'lang' => 'ru',
                "imageUpload" => "/admin/coach/news/upload",
                "minHeight" => 300
            ),
        ));?>
    </div>
...
<div class="control-group formSep">
    ...
    <div class="controls well">
        ...
        $this->widget('ext.xupload.XUpload', array(
                'url' => Yii::app( )->createUrl( "/admin/coach/news/uploadNewsImage/item/" . $id),
                'model' => $photos,
                ...
                'options' => array(
                    ...
                    'success'=>"js:function(result, textStatus, jqXHR) {
                                    $('#CoachNews_image_id').attr('value', result[0].image_id);
                                }",
                    'added' => "js:function() {
...
$cs->registerScriptFile('/js/admin/coach_news.js', CClientScript::POS_END);
?>