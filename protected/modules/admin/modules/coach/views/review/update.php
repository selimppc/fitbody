...
<?php if(isset($model->id)): ?>
    <h3 class="mb_30">Обновить отзыв: </h3>
<?php else: ?>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        <?php echo $form->dropDownList($model, "material_id", $coaches, array('empty' => '- Выберите тренера -', 'class' => 'span5')); ?>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        <?php echo $form->dropDownList($model, "user_id", $users, array('empty' => '- Выберите ползователя -', 'class' => 'span5')); ?>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        <?php echo $form->textArea($model, 'review', array('class' => 'span5', 'rows' => 15)); ?>
