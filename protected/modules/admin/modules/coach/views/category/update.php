...
<div class="control-group formSep">
    <?php echo $form->label($model,'dative',array('class'=>'control-label')); ?>
    <div class="controls">
        <?php echo $form->textField($model,'dative', array('class' => 'span5')); ?>
        <?php  echo $form->error($model,'dative',array('class'=>'label label-important')); ?>
    </div>
</div>
...
<div class="control-group formSep">
    ...
    <div class="controls">
        <?php echo $form->textArea($model,'description', array('class' => 'span5', 'cols' => 15, 'rows' => 12)); ?>
