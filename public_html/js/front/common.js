...
//		rewindNav: false,
    ...
    if(sync1){
        ...
        var owl1 = sync1.data('owlCarousel');
        if(sync1 && owl1){
            ...
            sync1.find(".owl-item").mousedown(function(){
...
//		});
	...
	$('.sub_top_nav').hover(function(){
		$(this).prev('a').addClass('hover');
	}, function(){
		$(this).prev('a').removeClass('hover');
	});
	//additional white line
	$('nav.top_nav > ul > li > a').each(function(){
		if($(this).next('.sub_top_nav').length){
