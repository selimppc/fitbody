...
$(document).ready(function() {
    ...
    var uploaderImages = new Uploader({
        formId: '#shopImageForm',
        uploadedUrl: '/admin/shop/shop/UploadedMultipleImages/'
    });
    var clubId = $('#shopForm').attr('data-id');
    if (clubId) {
    ...
    var uploaderMainImage = new Uploader({
        formId: '#shopForm',
        uploadedUrl: '/admin/shop/shop/UploadedSingleMainImage/'
    });
...
if (lastTab) {
    $('#shopTabs a[href="' + lastTab + '"]' ).tab('show');
}
// end history tab
...
$(document).on('click', '#Shop_radio>input', function(e) {
    var _this = $(this);
